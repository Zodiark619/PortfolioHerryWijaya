...
namespace PortfolioHerryWijaya.Migrations
{
    ...
    [Migration("20250116123535_usermodel_isadmin")]
    partial class usermodel_isadmin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PortfolioHerryWijaya.Models.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "admin",
                            RecoveryCode = 0,
                            RegisterDate = new DateTime(2025, 1, 16, 19, 35, 35, 104, DateTimeKind.Local).AddTicks(8015)
                        });
                });
